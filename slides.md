...
<sub>Transpose characters.</sub>

^ Got your i after an e.

-------------------------------------------------------------------------------

`dw`

<sub>Delete till end of word.</sub>

-------------------------------------------------------------------------------

`diw`

<sub>Delete the current word.</sub>

-------------------------------------------------------------------------------

`d2w`

<sub>Delete two words.</sub>

-------------------------------------------------------------------------------

`dd`

<sub>Delete a line.</sub>

-------------------------------------------------------------------------------

`d2d`

<sub>Delete two lines.</sub>

^ This works in all kinds of places.
Change for instance.
